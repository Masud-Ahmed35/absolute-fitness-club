...
const QandA = () => {
    return (
        <div className='m-11 grid grid-cols-1 lg:grid-cols-3 gap-10'>
            <div className=''>
                <h1 className='text-2xl font-bold'>How does ReactJs works?</h1>
            ...
            <div className=''>
                <h1 className='text-2xl font-bold'>Difference between props and state.</h1>
            ...
            <div className=''>
                <h1 className='text-2xl font-bold'>What are the uses of useEffect?</h1>
